...
pub trait Optimizer {
    ...
    fn update(&mut self, grads: &HashMap<&Var, Var>, ctx: &mut Context);
}
...
pub struct Sgd {
    ...
    b: HashMap<Var, Tensor>, // hashmap to store momentum tensors
    g: HashMap<Var, Tensor>,
}
...
pub struct Adam {
    ...
    m_t: HashMap<Var, Tensor>, // hashmap to store momentum tensors
    v_t: HashMap<Var, Tensor>,
}
